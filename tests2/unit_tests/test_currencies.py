...
class TestCachedForexLookupCurrencyConverter(unittest.TestCase):
    @patch('mecon2.utils.currencies.pathlib.Path')
...
class TestHybridLookupCurrencyConverter(unittest.TestCase):
    @patch('mecon2.utils.currencies.FixedRateCurrencyConverter', autospec=True)
    @patch('mecon2.utils.currencies.CachedForexLookupCurrencyConverter', autospec=True)
