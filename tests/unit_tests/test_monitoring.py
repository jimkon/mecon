...
class TestPerformanceDataAggregator(unittest.TestCase):
    def test_aggregation(self):
        logs_data_obj = log_data.LogData(pd.DataFrame({
            ...
            'description': [
                'mecon.transactions.Transactions.__init__ started... #codeflow#start#Transactions.__init__#import_data#transactions#process',
                'mecon.transactions.Transactions.__init__ finished... #codeflow#end#Transactions.__init__#import_data#transactions#process',
                'mecon.transactions.Transactions.__init__ started... #codeflow#start#Transactions.__init__#import_data#transactions#process',
                'mecon.transactions.Transactions.__init__ finished... #codeflow#end#Transactions.__init__#import_data#transactions#process',
                'mecon.transactions.Transactions.__init__ started... #codeflow#start#Transactions.__init__#import_data#transactions#process',
                'mecon.transactions.Transactions.__init__ finished... #codeflow#end#Transactions.__init__#import_data#transactions#process',
            ...
            'tags': [  # only 'start' and 'end' tags will be different
                'codeflow,start,Transactions.__init__,import_data,transactions,process',
                'codeflow,end,Transactions.__init__,import_data,transactions,process',
                'codeflow,start,Transactions.__init__,import_data,transactions,process',
                'codeflow,end,Transactions.__init__,import_data,transactions,process',
                'codeflow,start,Transactions.__init__,import_data,transactions,process',
                'codeflow,end,Transactions.__init__,import_data,transactions,process',
        ...
        expected_df = pd.DataFrame({'datetime': [Timestamp('2023-09-29 18:11:58.298000'),
                                    ...
                                    'tags': ['Transactions.__init__,import_data,transactions,process',
                                             'Transactions.__init__,import_data,transactions,process',
                                             'Transactions.__init__,import_data,transactions,process',
                                             'Transactions.__init__,import_data,transactions,process',
                                             'Transactions.__init__,import_data,transactions,process',
                                             'Transactions.__init__,import_data,transactions,process',
...
class TestPerformanceData(unittest.TestCase):
    def setUp(self) -> None:
        self.example_perf_data = log_data.PerformanceData(pd.DataFrame.from_dict({
            ...
            2: {'datetime': Timestamp('2023-09-29 18:11:58.00300000'),
                'execution_time': 28,
                'tags': 'get_filtered_transactions,import_data,transactions,process'},
            3: {'datetime': Timestamp('2023-09-29 18:11:58.00400000'),
                'execution_time': 3,
                'tags': 'get_transactions,import_data,transactions,load'},
            4: {'datetime': Timestamp('2023-09-29 18:11:58.00500000'),
                'execution_time': 1,
                'tags': 'Transactions.__init__,import_data,transactions,process'},
            7: {'datetime': Timestamp('2023-09-29 18:11:58.00800000'),
                'execution_time': 4,
                'tags': 'DataframeWrapper.apply_rule,import_data,transactions,tags'},
            ...
            16: {'datetime': Timestamp('2023-09-29 18:11:58.0170000'),
                 'execution_time': 13,
                 'tags': 'DataframeWrapper.groupagg,import_data,transactions,groupagg'},
            18: {'datetime': Timestamp('2023-09-29 18:11:58.0190000'),
                 'execution_time': -1,
                 'tags': 'Grouping.group,import_data,transactions,process'},
            ...
            23: {'datetime': Timestamp('2023-09-29 18:11:58.0240000'),
                 'execution_time': 5,
                 'tags': 'Aggregator.aggregate,import_data,transactions,process'},
    ...
    def test_from_log_data(self):
        ...
        # 2023-09-29 18:11:58,003,root,INFO,logs,wrapper,~mecon.blueprints.reports.reports_bp.get_filtered_transactions started... #codeflow#start#get_filtered_transactions#import_data#transactions#process~
        # 2023-09-29 18:11:58,004,root,INFO,logs,wrapper,~mecon.blueprints.reports.reports_bp.get_transactions started... #codeflow#start#get_transactions#import_data#transactions#load~
        # 2023-09-29 18:11:58,005,root,INFO,logs,wrapper,~mecon.transactions.Transactions.__init__ started... #codeflow#start#Transactions.__init__#import_data#transactions#process~
        # 2023-09-29 18:11:58,006,root,INFO,logs,wrapper,~mecon.transactions.Transactions.__init__ finished... #codeflow#end#Transactions.__init__#import_data#transactions#process~
        # 2023-09-29 18:11:58,007,root,INFO,logs,wrapper,~mecon.blueprints.reports.reports_bp.get_transactions finished... #codeflow#end#get_transactions#import_data#transactions#load~
        # 2023-09-29 18:11:58,008,root,INFO,logs,wrapper,~mecon.datafields.DataframeWrapper.apply_rule started... #codeflow#start#DataframeWrapper.apply_rule#import_data#transactions#tags~
        # 2023-09-29 18:11:58,009,root,INFO,logs,wrapper,~mecon.transactions.Transactions.__init__ started... #codeflow#start#Transactions.__init__#import_data#transactions#process~
        # 2023-09-29 18:11:58,010,root,INFO,logs,wrapper,~a random log #notcodeflow#start#balance_graph#api~
        # 2023-09-29 18:11:58,011,root,INFO,logs,wrapper,~mecon.transactions.Transactions.__init__ finished... #codeflow#end#Transactions.__init__#import_data#transactions#process~
        # 2023-09-29 18:11:58,012,root,INFO,logs,wrapper,~mecon.datafields.DataframeWrapper.apply_rule finished... #codeflow#end#DataframeWrapper.apply_rule#import_data#transactions#tags~
        # 2023-09-29 18:11:58,013,root,INFO,logs,wrapper,~mecon.datafields.DataframeWrapper.apply_rule started... #codeflow#start#DataframeWrapper.apply_rule#import_data#transactions#tags~
        # 2023-09-29 18:11:58,014,root,INFO,logs,wrapper,~mecon.transactions.Transactions.__init__ started... #codeflow#start#Transactions.__init__#import_data#transactions#process~
        # 2023-09-29 18:11:58,015,root,INFO,logs,wrapper,~mecon.transactions.Transactions.__init__ finished... #codeflow#end#Transactions.__init__#import_data#transactions#process~
        # 2023-09-29 18:11:58,016,root,INFO,logs,wrapper,~mecon.datafields.DataframeWrapper.apply_rule finished... #codeflow#end#DataframeWrapper.apply_rule#import_data#transactions#tags~
        # 2023-09-29 18:11:58,017,root,INFO,logs,wrapper,~mecon.datafields.DataframeWrapper.groupagg started... #codeflow#start#DataframeWrapper.groupagg#import_data#transactions#groupagg~
        # 2023-09-29 18:11:58,018,root,INFO,logs,wrapper,~a random log #notcodeflow#start#balance_graph#api~
        # 2023-09-29 18:11:58,019,root,INFO,logs,wrapper,~mecon.datafields.Grouping.group started... #codeflow#start#Grouping.group#import_data#transactions#process~
        # 2023-09-29 18:11:58,021,root,INFO,logs,wrapper,~mecon.transactions.Transactions.__init__ started... #codeflow#start#Transactions.__init__#import_data#transactions#process~
        # 2023-09-29 18:11:58,022,root,INFO,logs,wrapper,~mecon.transactions.Transactions.__init__ started... #codeflow#start#Transactions.__init__#import_data#transactions#process~
        # 2023-09-29 18:11:58,023,root,INFO,logs,wrapper,~mecon.transactions.Transactions.__init__ finished... #codeflow#end#Transactions.__init__#import_data#transactions#process~
        # 2023-09-29 18:11:58,024,root,INFO,logs,wrapper,~mecon.datafields.Aggregator.aggregate started... #codeflow#start#Aggregator.aggregate#import_data#transactions#process~
        # 2023-09-29 18:11:58,025,root,INFO,logs,wrapper,~mecon.transactions.Transactions.__init__ started... #codeflow#start#Transactions.__init__#import_data#transactions#process~
        # 2023-09-29 18:11:58,026,root,INFO,logs,wrapper,~mecon.transactions.Transactions.__init__ started... #codeflow#start#Transactions.__init__#import_data#transactions#process~
        # 2023-09-29 18:11:58,027,root,INFO,logs,wrapper,~mecon.transactions.Transactions.__init__ started... #codeflow#start#Transactions.__init__#import_data#transactions#process~
        # 2023-09-29 18:11:58,028,root,INFO,logs,wrapper,~mecon.transactions.Transactions.__init__ finished... #codeflow#end#Transactions.__init__#import_data#transactions#process~
        # 2023-09-29 18:11:58,029,root,INFO,logs,wrapper,~mecon.datafields.Aggregator.aggregate finished... #codeflow#end#Aggregator.aggregate#import_data#transactions#process~
        # 2023-09-29 18:11:58,030,root,INFO,logs,wrapper,~mecon.datafields.DataframeWrapper.groupagg finished... #codeflow#end#DataframeWrapper.groupagg#import_data#transactions#groupagg~
        # 2023-09-29 18:11:58,031,root,INFO,logs,wrapper,~mecon.blueprints.reports.reports_bp.get_filtered_transactions finished... #codeflow#end#get_filtered_transactions#import_data#transactions#process~
        ...
        log_data_df = pd.DataFrame.from_dict({
            ...
            2: {'datetime': Timestamp('2023-09-29 18:11:58.00300000'), 'level': 'INFO', 'module': 'logs',
                'funcName': 'wrapper',
                'description': 'mecon.blueprints.reports.reports_bp.get_filtered_transactions started... #codeflow#start#get_filtered_transactions#import_data#transactions#process',
                'tags': 'codeflow,start,get_filtered_transactions,import_data,transactions,process'},
            3: {'datetime': Timestamp('2023-09-29 18:11:58.00400000'), 'level': 'INFO', 'module': 'logs',
                'funcName': 'wrapper',
                'description': 'mecon.blueprints.reports.reports_bp.get_transactions started... #codeflow#start#get_transactions#import_data#transactions#load',
                'tags': 'codeflow,start,get_transactions,import_data,transactions,load'},
            4: {'datetime': Timestamp('2023-09-29 18:11:58.00500000'), 'level': 'INFO', 'module': 'logs',
                'funcName': 'wrapper',
                'description': 'mecon.transactions.Transactions.__init__ started... #codeflow#start#Transactions.__init__#import_data#transactions#process',
                'tags': 'codeflow,start,Transactions.__init__,import_data,transactions,process'},
            5: {'datetime': Timestamp('2023-09-29 18:11:58.00600000'), 'level': 'INFO', 'module': 'logs',
                'funcName': 'wrapper',
                'description': 'mecon.transactions.Transactions.__init__ finished... #codeflow#end#Transactions.__init__#import_data#transactions#process',
                'tags': 'codeflow,end,Transactions.__init__,import_data,transactions,process'},
            6: {'datetime': Timestamp('2023-09-29 18:11:58.00700000'), 'level': 'INFO', 'module': 'logs',
                'funcName': 'wrapper',
                'description': 'mecon.blueprints.reports.reports_bp.get_transactions finished... #codeflow#end#get_transactions#import_data#transactions#load',
                'tags': 'codeflow,end,get_transactions,import_data,transactions,load'},
            7: {'datetime': Timestamp('2023-09-29 18:11:58.00800000'), 'level': 'INFO', 'module': 'logs',
                'funcName': 'wrapper',
                'description': 'mecon.datafields.DataframeWrapper.apply_rule started... #codeflow#start#DataframeWrapper.apply_rule#import_data#transactions#tags',
                'tags': 'codeflow,start,DataframeWrapper.apply_rule,import_data,transactions,tags'},
            ...
            11: {'datetime': Timestamp('2023-09-29 18:11:58.0120000'), 'level': 'INFO', 'module': 'logs',
                 'funcName': 'wrapper',
                 'description': 'mecon.datafields.DataframeWrapper.apply_rule finished... #codeflow#end#DataframeWrapper.apply_rule#import_data#transactions#tags',
                 'tags': 'codeflow,end,DataframeWrapper.apply_rule,import_data,transactions,tags'},
            ...
            16: {'datetime': Timestamp('2023-09-29 18:11:58.0170000'), 'level': 'INFO', 'module': 'logs',
                 'funcName': 'wrapper',
                 'description': 'mecon.datafields.DataframeWrapper.groupagg started... #codeflow#start#DataframeWrapper.groupagg#import_data#transactions#groupagg',
                 'tags': 'codeflow,start,DataframeWrapper.groupagg,import_data,transactions,groupagg'},
            ...
            18: {'datetime': Timestamp('2023-09-29 18:11:58.0190000'), 'level': 'INFO', 'module': 'logs',
                 'funcName': 'wrapper',
                 'description': 'mecon.datafields.Grouping.group started... #codeflow#start#Grouping.group#import_data#transactions#process',
                 'tags': 'codeflow,start,Grouping.group,import_data,transactions,process'},
            ...
            23: {'datetime': Timestamp('2023-09-29 18:11:58.0240000'), 'level': 'INFO', 'module': 'logs',
                 'funcName': 'wrapper',
                 'description': 'mecon.datafields.Aggregator.aggregate started... #codeflow#start#Aggregator.aggregate#import_data#transactions#process',
                 'tags': 'codeflow,start,Aggregator.aggregate,import_data,transactions,process'},
            ...
            28: {'datetime': Timestamp('2023-09-29 18:11:58.0290000'), 'level': 'INFO', 'module': 'logs',
                 'funcName': 'wrapper',
                 'description': 'mecon.datafields.Aggregator.aggregate finished... #codeflow#end#Aggregator.aggregate#import_data#transactions#process',
                 'tags': 'codeflow,end,Aggregator.aggregate,import_data,transactions,process'},
            29: {'datetime': Timestamp('2023-09-29 18:11:58.0300000'), 'level': 'INFO', 'module': 'logs',
                 'funcName': 'wrapper',
                 'description': 'mecon.datafields.DataframeWrapper.groupagg finished... #codeflow#end#DataframeWrapper.groupagg#import_data#transactions#groupagg',
                 'tags': 'codeflow,end,DataframeWrapper.groupagg,import_data,transactions,groupagg'},
            30: {'datetime': Timestamp('2023-09-29 18:11:58.0310000'), 'level': 'INFO', 'module': 'logs',
                 'funcName': 'wrapper',
                 'description': 'mecon.blueprints.reports.reports_bp.get_filtered_transactions finished... #codeflow#end#get_filtered_transactions#import_data#transactions#process',
                 'tags': 'codeflow,end,get_filtered_transactions,import_data,transactions,process'},
