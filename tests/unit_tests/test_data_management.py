...
#     def test_data_cache_reset(self):
#         data_cache = DataManager()._cache
...
class TestDataManager(unittest.TestCase):
    ...
    def test_reset_transactions(self):
        with patch.object(self.data_manager, 'reset_tags'):
            ...
            self.data_manager.reset_tags.assert_called_once()
            self.data_manager._cache.reset.assert_called_once()
    ...
    def test_update_tag(self):
        tag = Mock()
        with patch.object(self.data_manager, 'reset_tags') as mock_reset_tags:
