...
from legacy import configs, logs
from legacy import calendar_utils
from legacy.statements.combined_statement import Transactions
from legacy.tagging.tags import ALL_TAGS
...
if __name__ == "__main__":
    ...
    from legacy.tagging.json_tags import SelectQuery
